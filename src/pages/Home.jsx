...
const Home = () => {
	...
	const [submitted, isSubmitted] = React.useState(false);
					...
					<Box overflow="hidden">
						...
						<Box p="4" alignItems="center">
							<Box d="flex" flexDirection="column" alignItems="baseline">
								<h2 style={{ whiteSpace: "nowrap" }}>Stay updated!</h2>
								<p>
									Join over 60.000+ product managers receiving monthly updates
									from:
								</p>
							</Box>
							<Box d="flex" alignItems="center" marginTop="1.8rem">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="21"
									height="21"
							...
							<Box d="flex" alignItems="center" marginTop="0.8rem">
								<svg
									xmlns="http://www.w3.org/2000/svg"
									width="21"
									height="21"
					...
					<Box display="flex" justifyContent="space-between" bg="white">
						...
						>
							...
							<p style={{ marginTop: "1rem" }}>
								A confirmation email has benn sent to{" "}
